...
public class PhantomJSDesiredCapabalities {
    ...
    public Capabilities createPhantomJSCapabilities() {
        ...
        caps.setCapability(PhantomJSDriverService.PHANTOMJS_CLI_ARGS,
            new String[]{
                "--remote-debugger-port=6666" + "/Users/johgri/Documents/dev/RMTest/java/rmtest-core/src/main/java/se/redmind/rmtest/selenium/grid/PhantomJSScripts/TestDebugging.js",
                "--remote-debugger-autorun=yes", "--logLevel=5"
            });

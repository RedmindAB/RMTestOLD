...
import se.aftonbladet.abtest.navigation.TYW.TYWNav;
...
public class TestTYWBackend {
    private WebDriver tDriver;
    private TYWNav tNavPage;
    private String startUrl = TYWParams.getBaseUrl();

    private final DriverNamingWrapper driverWrapper;
    private final String driverDescription;

    public TestTYWBackend(final DriverNamingWrapper driverWrapper, final String driverDescription) {
    ...
    public void ensure_login_successful() throws Exception {
        ...
        tNavPage = new TYWNav(tDriver, startUrl);

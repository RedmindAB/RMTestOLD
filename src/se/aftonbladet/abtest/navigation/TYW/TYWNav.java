 ...
 */
public class TYWNav extends HTMLPage {
    private WebDriver driver = getDriver();

    public TYWNav(WebDriver pDriver, String serverUrl) throws Exception {
        super(pDriver);
        driver = pDriver;
        ...
        while (i < 10) {
            try {
                driver.get(Objects.firstNonNull(serverUrl, "http://stage.feature.aftonbladet.se:9000"));
                driverFluentWait(6).until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div/div/a/img")));
                break;
            }
            catch (Exception e) {
                System.out.println(i + " TYWNav: " + e);
                i = i + 1;
                Thread.sleep(500);
            }
        }
    ...
    public void TYWBackendLogOut() throws Exception {
        By logoutButtonPath = By.xpath("/html/body/div/div[2]/ul[2]/li[2]/a");
        driverWaitClickable(logoutButtonPath, 10);
        System.out.println("**************************************************** Logout initiated. ****************");
        spinnerClickBy(logoutButtonPath);
        driverWaitElementPresent(By.xpath("/html/body/div[2]/form/input[@type='text']"), 10);
    ...
    public boolean TYWIsLoggedIn() throws Exception {
        ...
        while (i < 10) {
            ...
            try {
                ...
                WebElement linkElement = driver.findElement(By.xpath("/html/body/div/div[2]/ul[2]/li[2]/a"));
    ...
    public void ImportTick(String storeName) throws Exception {
        By storeCheckBox = By.xpath("/html/body/div[2]/form/input[@value='" + storeName + "']");
        spinnerClickBy(storeCheckBox);
    }

    public void RunImporter() throws Exception {
        By runImportButton = By.xpath("/html/body/div[2]/form/input[@type='submit']");
